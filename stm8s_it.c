...
/**
 ...
 INTERRUPT_HANDLER(ADC1_IRQHandler, 22)
 {
   ...
   {
      adc_buffer[0] = ADC1_GetBufferValue(ADC1_CHANNEL_2); // S3
      adc_buffer[1] = ADC1_GetBufferValue(ADC1_CHANNEL_3); // S1 (t)
      adc_buffer[2] = ADC1_GetBufferValue(ADC1_CHANNEL_4); // S2 (t)
      adc_ready = 1;
