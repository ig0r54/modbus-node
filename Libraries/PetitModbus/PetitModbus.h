...
#define NUMBER_OF_OUTPUT_PETITREGISTERS                 4                       // Petit Modbus RTU Slave Output Register Number
...
#define PETITMODBUSWRITE_SINGLE_REGISTER_ENABLED        ( 0 )                   // If you want to use make it 1, or 0
#define PETITMODBUS_WRITE_MULTIPLE_REGISTERS_ENABLED    ( 0 )                   // If you want to use make it 1, or 0
